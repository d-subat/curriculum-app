...
class Signature extends Component {
      ...
      onMouseDown =  (e) => {
        ...
        this.prevPos = { offsetX: e.nativeEvent.offsetX || e.touches[0].clientX, offsetY: e.nativeEvent.offsetY || (e.touches[0].clientY- this.canvas.offsetTop)} ;
      }

      onMouseMove = (e) => {
        if (this.isPainting) {          
          const offSetData = { offsetX: e.nativeEvent.offsetX || e.touches[0].clientX, offsetY: e.nativeEvent.offsetY || (e.touches[0].clientY- this.canvas.offsetTop)};
      ...
      render() {
        return (<>
          {this.state.showStatus &&  
              <div className="status" onClick={() => this.setState({showStatus: !this.state.showStatus})}>
      ...
      <button className="btn confirm" onClick={  this.saveSignature} >
